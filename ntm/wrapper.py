...
class EncapsulatedNTM(nn.Module):
    ...
    def __init__(self, num_inputs, num_outputs,
        ...
        controller = LSTMController(num_inputs + M*num_heads, controller_size, controller_layers, M * self.num_heads + num_inputs, num_outputs, controller_size + self.num_heads * M)
        heads = nn.ModuleList([])
